...
<body>
    ...
    <div id="sliderFrame">
        <div id="slider">
            <img src="images/2.png" alt="iConnect" />
            <img src="images/1.png" alt="iConnect" />
            <img src="images/3.jpg" alt="iConnect" />
            <img src="images/4.jpg" alt="iConnect"/>
        </div>
	...
	<div class="test" id="testimonials">
		<div class="container">
			<div class="test-top">
				...
				<h3>What is Special About iConnect</h3>
				<p>The place where you meet customize based all hardware & software solutions under one roof. the core focus of iconnect is to serve their esteemed customers like corporate clients & enduser.</p>
			</div>
		<!--	<div class="test-bottom">
				<div class="col-md-4 test-bottom-left">
					<div class="test-left">
						<p><span>@iConnect</span> asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf adsf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf adsf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf  asdf asdf .</p>
						<div class="test-btm">
							<div class="test-1">
	...
	<div class="footer">
		<div class="container">
			<div class="footer-main">
				<p>&copy 2015 iConnect Solutions</p>
				<ul>
